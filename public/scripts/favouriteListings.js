$(document).ready(function() {
  ...
  const createListingElement = function(listing) {
    ...
    <i class="far fa-heart" data-listing="${listing.listing_id}" data-user="${listing.userid}" data-id="far-fa-heart" id="fas-fa-heart" style="padding: 10px;"> Cancel Favourite</i>
  ...
  // <a href="/listingDetails" class="btn btn-primary" id="viewListing" data-listing="${listing.listing_id}">View Listing</a>
  ...
  const loadListings = function(url) {
    return $.get({
      ...
      .then(function(listings) {
        ...
        // <button id="viewListing" data-listing="${listing.listing_id} class="btn btn-primary">View Listing</button>`

        const $viewListing = $('#viewListing');
        $viewListing.click(function(e) {
          e.preventDefault();
          $(e.target).data('id', "viewListing");

          let listing_id = $(this).attr('data-listing');
          console.log(listing_id)
          $.get(`/home/listings/${listing_id}`)
            .then((data) => {
